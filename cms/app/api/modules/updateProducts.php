			...
			if (isset($_SESSION['logged']) && $_SESSION['logged'] == true ) {
				...
				else
				{
					...
					if ($image['error'] == NULL) {
						...
						sprintf("UPDATE `products` SET `title` =  '%s', `slug` =  '%s', `category` = '%s', `short` = '%s', `subtitle` = '%s', `description` = '%s', `additional` = '%s', `image` = '%s' WHERE `id` ='%s';",
						...
						if ($result = @$connection->query(
						sprintf("UPDATE `products` SET `title` =  '%s', `slug` =  '%s', `category` = '%s', `short` = '%s', `subtitle` = '%s', `description` = '%s', `additional` = '%s' WHERE `id` ='%s';",
						mysqli_real_escape_string($connection,$title),
						mysqli_real_escape_string($connection,$slug),
						mysqli_real_escape_string($connection,$category),
						mysqli_real_escape_string($connection,$short),
